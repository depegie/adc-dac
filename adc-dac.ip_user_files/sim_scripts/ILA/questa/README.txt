...
#
# Generated by export_simulation on Thu Jun 09 16:36:35 CEST 2022
#
################################################################################
...
'-reset_run' switch to the './ILA.sh' script.
...
./ILA.sh -noclean_files

For more information on the script, please type './ILA.sh -help'.
