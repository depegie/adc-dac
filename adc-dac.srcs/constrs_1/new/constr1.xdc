...
##Pmod Header JC
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports SYNCn]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports DIN]
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { jc[2] }]; #IO_L1P_T0_34 Sch=jc_p[2]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports SCLK_DAC]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports CSn]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports SDATA]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { je[2] }]; #IO_25_35 Sch=je[3]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports SCLK_ADC]
